    ...
    <?php include('sidemenu.php'); ?>
        ...
        <p style="color: red;"><?php if(isset($_GET['error'])){ echo $_GET['error']; } ?></p>
            ...
            <label for="">Title</label>
                <input type="text" class="form-control" id="properties-name"  name="name" placeholder="title" required>
            </div>
            <div class="form-group mt-2">
                <label for="">Description</label>
                <input type="text" class="form-control" id="properties-discription" name="description" placeholder="description" required>
            </div>
           
            <div class="form-group mt-2">
                <label for="">Price</label>
                <input type="text" class="form-control" id="properties-price"  name="price" placeholder="price" required>
            </div>
            <div class="form-group mt-2">
            <label for="">Category</label>
            <input type="text" class="form-control" id="properties-category"  name="category" placeholder="category" required>
            </div>
