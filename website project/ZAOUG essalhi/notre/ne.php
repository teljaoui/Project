...
<!--	Banner -->
<div class="banner-full-row page-banner" style="background-image:url('breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">temera massira 1</span> 
										<span class="text-secondary">temara,massira1</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-secondary">212 34 567 809</span>
										<span class="text-secondary">212 34 567 809 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-secondary">CONTACT@gmail.com</span>
										<span class="text-secondary">CONTACT@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
 ...
 <!--	Map -->
 <iframe src="https://maps.google.com/maps?width=&amp;height=450&amp;hl=en&amp;q=morocco%20temara+(ista%20temara)&amp;ie=UTF8&amp;t=&amp;z=13&amp;iwloc=B&amp;output=embed" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		<!--	Map -->
