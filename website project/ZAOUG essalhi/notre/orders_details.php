...
function calculateTotalOrder($order_details){
    ...
    foreach($order_details as $row){
        $product_price = $row['properties_price'];
        ...
        <tr>
            <td>
                <div class="product-info">
                    <img src="img/<?php echo $row['properties_image']; ?>" alt="">
                    <div>
                        <p class="mt-3"><?php echo $row['properties_name']; ?></p>
                    </div>
                </div>
            </td>
            <td>
                <span>$<?php echo $row['properties_price']; ?></span>
            </td>
